...
This project uses the [kb-skills-bioinformatics](https://github.com/yyw-informatics/kb-skills-bioinformatics) Codex plugin for literature review, method evaluation, and analysis design.
...
Each skill's `SKILL.md` documents prerequisites, arguments, and outputs in detail. If a skill body shows Claude-style `/skill-name` examples, use the equivalent Codex `$skill-name` invocation.
