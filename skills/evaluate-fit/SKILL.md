...
argument-hint: [method-name] [context-file.md] | --all [context-file.md] [--project=folder] [--ensemble-summary] | --methods=a,b,c [context-file.md] [--project=folder] [--ensemble-summary]
allowed-tools: Read, Glob, Grep, Write, Edit, AskUserQuestion, Bash(mkdir *, mv *, ls *, wc *), Task, TaskOutput
---
