...
argument-hint: "[0_synthesis_literature.md] [context.md] --project=folder | --refresh"
allowed-tools: Read, Glob, Grep, Write, Edit, AskUserQuestion, Bash(mkdir *, wc *, rm *), Task, TaskOutput
---
